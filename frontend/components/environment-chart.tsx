...
export function EnvironmentChart() {
    ...
    let tickInterval = 3600 * 4
    if (timeRange === "6") tickInterval = 3600
    else if (timeRange === "12") tickInterval = 3600 * 2
    else if (timeRange === "24") tickInterval = 3600 * 4
    else if (timeRange === "72") tickInterval = 3600 * 12
    else if (timeRange === "168") tickInterval = 3600 * 24
